...
G.add_node(3, URL='http://example.com/D')
...
for start, end in extend_edges:
    start_point = graph_renderer.layout_provider.graph_layout[start]
    end_point = graph_renderer.layout_provider.graph_layout[end]
    arrow = Arrow(end=NormalHead(fill_color="blue", size=15), line_color="blue", x_start=start_point[0], y_start=start_point[1], x_end=end_point[0], y_end=end_point[1])
    plot.add_layout(arrow)
